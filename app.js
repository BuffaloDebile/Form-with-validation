const inputUtilisateur = document.querySelector(
...
// validation creation du mot de passe

let valeurInp;

const specialCar = /[^a-zA-Z0-9]/; // tout les characteres speciaux
const alphabet = /[a-z]/i; // tout l'alphabet
...
inpMdp.addEventListener('input', (e) => {
  ...
  // validation input au changement ou suppression
